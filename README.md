...
> has completed paired v1/v2 TRAIN development pilots on H200. A synthetic diagnostic found sharply lower error probabilities in longer answers; a binary follow-up matched all ten constructed cases, and a TRAIN token audit is ready. No final test results are available yet.
