...
The [development reservation design](DEVELOPMENT_SPLIT_PROTOCOL.md) now fixes 100 exact-overlap components per calibration/threshold role and deterministic allocation before labels or scores. Selection and fitting remain unimplemented; the design provides no generation allowance.
