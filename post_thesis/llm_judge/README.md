...
next-token log probabilities as the next candidate. It remains unimplemented and
uncalibrated; the next deliverable is an offline prompt/tokenizer contract, with
no new generation allowance.
